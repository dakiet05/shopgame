...
namespace xuonggame.Areas.ADMIN.Controllers
{
    public class OrderDetailsController : Controller
    {
        ...
        public ActionResult Create()
        {
            ...
            ViewBag.ProductId = new SelectList(db.Products, "ProId", "ProName");
            return View();
        }
        ...
        public ActionResult Create([Bind(Include = "OrderId,ProductId,Price,Quantity")] OrderDetail orderDetail)
        {
            ...
            ViewBag.ProductId = new SelectList(db.Products, "ProId", "ProName", orderDetail.ProductId);
            return View(orderDetail);
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "OrderId,ProductId,Price,Quantity")] OrderDetail orderDetail)
        {
            if (ModelState.IsValid)
            {
