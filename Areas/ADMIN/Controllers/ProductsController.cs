...
namespace xuonggame.Areas.ADMIN.Controllers
{
    public class ProductsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "ProId,ProName,ProImage,ProInfo,ProPrice,ProBannerImg,CatId")] Product product)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "ProId,ProName,ProImage,ProInfo,ProPrice,ProBannerImg,CatId")] Product product)
        {
            if (ModelState.IsValid)
            {
